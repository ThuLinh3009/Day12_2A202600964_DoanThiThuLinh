...
MOCK_RESPONSES = {
    ...
    "scale": ["Scaling cho phép tăng số lượng instances để xử lý nhiều requests hơn."],
    "redis": ["Redis là in-memory data store, dùng để lưu session, cache, và rate limit counters."],
    "auth": ["Authentication xác minh danh tính người dùng. Authorization kiểm tra quyền truy cập."],
    "rate": ["Rate limiting giới hạn số requests mỗi phút để bảo vệ hệ thống khỏi bị lạm dụng."],
}
